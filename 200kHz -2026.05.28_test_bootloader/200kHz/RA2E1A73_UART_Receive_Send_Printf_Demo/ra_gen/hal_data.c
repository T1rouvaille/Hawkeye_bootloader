...
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.0001180625 seconds. Actual duty: 0%. */.period_counts = (uint32_t) 0x1623,
  .duty_cycle_counts = 0x0, .source_div = (timer_source_div_t) 0, .channel = 5, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.00001 seconds. Actual duty: 0%. */.period_counts = (uint32_t) 0x1e0,
  .duty_cycle_counts = 0x0, .source_div = (timer_source_div_t) 0, .channel = 7, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.0001180625 seconds. Actual duty: 0%. */.period_counts = (uint32_t) 0x1623,
  .duty_cycle_counts = 0x0, .source_div = (timer_source_div_t) 0, .channel = 6, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
